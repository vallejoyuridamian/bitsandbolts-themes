...
const PORTAL_PRESENTATION_PROPERTIES = Object.freeze([
  ...
  '--bb-interface-button-hover-background',
  '--bb-interface-button-hover-shadow',
  '--bb-interface-button-hover-text-shadow',
  '--bb-interface-button-hover-foreground',
  '--bb-interface-button-hover-filter',
  '--bb-interface-button-pressed-background',
  '--bb-interface-button-pressed-shadow',
  '--bb-interface-button-pressed-text-shadow',
  '--bb-interface-button-pressed-foreground',
  '--bb-interface-button-pressed-filter',
